...
public class SecurityConfig {
    ...
    /**
     * Prevents Spring Security's {@code UserDetailsServiceAutoConfiguration}
     * from creating an {@code InMemoryUserDetailsManager} with a generated
     * password. This app authenticates entirely via JWT; no
     * {@code UserDetailsService} is ever consulted at runtime.
     */
    @Bean
    public UserDetailsService userDetailsService() {
        return username -> {
            throw new UsernameNotFoundException("JWT-only authentication; no UserDetailsService");
        };
    }
